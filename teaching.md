...
- **Filip Rydin** — Master’s thesis: *Energy-Based Deep Splitting for Fast and Accurate Estimation of Filtering Densities* (2024).  
...
- **MVE565 – Computational Methods for Stochastic Differential Equations**  
  *Teaching assistant*, Chalmers (2024).  
  [Course page](#) <!-- TODO: replace # with the real URL -->
